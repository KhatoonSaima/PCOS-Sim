...
- Firebase account
- Required data files:
  * Cleaned-Data-new.csv (PCOS training dataset)
  * pcos-service-key.json (Firebase credentials)

2. INSTALLATION STEPS
---------------------
2.1 Download the pcos_final.py file
...
4. DATA FILES
-------------
Place these files in the same location where pcos_final.py file is present:
...
7.1 File not found errors:
    ...
    - Check pcos-service-key.json path in app.py
...
8. CUSTOMIZATION
----------------
To modify treatment effects, edit in pcos_final.py:
