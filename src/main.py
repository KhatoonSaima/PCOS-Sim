...
if not firebase_admin._apps:
    cred = credentials.Certificate("pcoscare-20ed8-firebase-adminsdk.json")
...
with st.form("user_form"):
    ...
    hyperandrogenism = st.selectbox("Hyperandrogenism?(Excessive Male Hormones)", ["No", "Yes"])
    hirsutism = st.selectbox("Hirsutism?(Excessive male pattern hair growth)", ["No", "Yes"])
